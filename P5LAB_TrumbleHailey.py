...
def add_items(dictionary):
    cart = []
    item = input("Enter an item to add to the chart or type 'end' to stop adding items")
        
    while item != "end":
      if item in dictionary.keys():
          cart.append(item)
      else:
            print(f"{item} ia not in stock")
            item = input("Enter an item to add  to the cart or type")
